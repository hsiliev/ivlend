...
Instructions:
	...
	Overview:
		...
		- The "lensMain wrapper": The skinny little column on the right. Home to what little
		...
		Note: Only the lensMain wrapper and the thumbnails section are actually present in
	...
	Keyboard shortcuts:
		...
		- Escape: Toggle the lensMain wrapper.
	...
	Other stuff:
		...
		- The lensMain wrapper can be moved to the left by changing the "misc.lensMain-side" variable
		  in assets/sass/libs/_vars.scss to "left" (and of course recompiling your CSS).

		- Additional tweakable settings can be found at the top of assets/js/lens-main.js, but
